...
(def COLORS (cycle [Color/RED Color/ORANGE Color/YELLOW Color/GREEN Color/BLUE Color/CYAN Color/MAGENTA Color/PINK]))

(defn paint-cells [graphics color cells]
  (.setColor graphics color)
  (doseq [t cells]
    (let [[x y] (:location t)]
      (.fillRect graphics (+ 251 (* x 10)) (+ 251 (* y 10)) 9 9))))
...
(defn world-panel [world]
  (proxy [JPanel] []
    (paintComponent [^Graphics graphics]
      ...
      (paint-cells graphics (Color/BLACK) (filter #(= :food (:type %)) (vals @(.stuff world)))))))
